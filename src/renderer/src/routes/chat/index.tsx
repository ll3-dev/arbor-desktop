...
//   const { data: existingChat } = useQuery(trpc.chat.getChat.queryOptions({ chatId: chatId || '' }))
...
//         const newChat = await createChatMutation.mutateAsync({ title: message.substring(0, 30) })
//         chatId = newChat.id
//       }

//       // Add user message to database
//       await addMessageMutation.mutateAsync({ chatId, content: message, role: 'user' })
